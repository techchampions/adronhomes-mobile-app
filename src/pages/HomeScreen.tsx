      ...
      <div className="grid grid-cols-3 grid-rows-3 gap-4">
        ...
        <div className="rounded-3xl p-6 text-center bg-white flex flex-col justify-between row-span-3">
          ...
          <div className="">
            ...
            <div className="bg-adron-body flex w-fit mx-auto shadow rounded-full px-4 my-1 text-xs justify-between items-center gap-2 mb-4 md:mb-0">
              <span>2 Houses</span>
          ...
          <a
            href="/properties"
            className="mt-4 text-adron-green font-bold text-sm"
          >
            View Properties
          </a>
        </div>
